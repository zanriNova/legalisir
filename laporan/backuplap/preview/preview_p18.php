...
// 	else 
 {
  ...
  $sql = mysql_query ("SELECT z.*,i.nm_tersangka,s.kasus FROM tb_p18 z LEFT JOIN 
    tb_bp p ON(z.id_bp=p.id_bp)  LEFT JOIN tb_spdp s ON(s.id_spdp=p.id_spdp) 
    left join  tb_identitas i ON(s.id_identitas=i.id_identitas) WHERE id_p18='".$_GET['Gid_p18']."'") or die (mysql_error());
...
<table border="0"  width="100%" align="center">
	<tr>
        ...
        <td width="3">:</td>
        <td width="238"><?php echo $isi['id_p18']; ?></td>
        <td width="72"></td>
        <td width="294">Kudus, <?php echo $isi['tgl_p18']; ?></td>
	</tr>
    <tr>
    ...
    <tr>
        ...
        <td width="238" valign="top">Hasil penyidikan atas nama tersangka <?php echo $isi['nm_tersangka']; ?> yang disangka melanggar <?php echo $isi['kasus']; ?> belum lengkap</td>
        <td width="72"></td>
...
<table border="0"  width="100%" align="center">
	<tr>
    	<td width="77">&nbsp;</td>
        <td width="615" align="justify">Sehubungan penyerahan berkas perkara pidana atas nama tersangka <?php echo $isi['nm_tersangka']; ?> Nomor : <?php echo $isi['id_bp']; ?> <?php echo $isi['keterangan']; ?></td>
    </tr>
    <tr>
    	<td width="77">&nbsp;</td>
        <td width="615">Pengembalian berkas perkara beserta petunjuknya menyusul.</td>
    </tr>
    <tr>
    	<td width="77">&nbsp;</td>
