...
?>
	...
	$sql2 = mysql_query ("SELECT p.*,i.nm_tersangka FROM tb_bp p LEFT JOIN tb_spdp s ON(s.id_spdp=p.id_spdp) left join tb_identitas i 
			ON(s.id_identitas=i.id_identitas) ORDER BY id_bp") or die (mysql_error());
